...
public actor CaptureManager {
    ...
    public struct Environment: @unchecked Sendable {
        ...
        // Services are `nil` when disabled in CaptureSettings or unavailable
        ...
        public static func live(
            ...
            rawEventBuffer:    CaptureEventBuffer,
    ...
    private let rawEventBuffer: CaptureEventBuffer
    ...
    public func startAll() async {
        await appState.setCaptureStatus(.capturing)
    ...
    private func syncCaptureStatus() async {
        ...
        let status: CaptureStatus = failingNames.isEmpty ? .capturing : .error("Services degraded: \(failingNames.joined(separator: ", "))")
