...
public final class AccessibilityCaptureService {
    ...
    private var currentEvent: CaptureEvent?
    ...
    private var recentlyClosed: [String: (event: CaptureEvent, closedAt: Date)] = [:]
    ...
    private func emitIfAllowed(_ event: CaptureEvent) async {
